...
def _build_inputs(payload: Any) -> tuple[OverwatchInputs, float, float | None, dict[str, Any]]:
    current_rank_numeric = overwatch_rank_to_numeric(payload.profile.current_rank_label)
    peak_rank_numeric = (
        overwatch_rank_to_numeric(payload.profile.peak_rank_label)
...
def score_overwatch(payload: Any) -> ScoringResult:
