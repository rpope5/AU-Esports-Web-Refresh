...
require_roster_viewer = require_permission("can_view_roster")
require_roster_manager = require_permission("can_manage_roster")
require_roster_deleter = require_permission("can_delete_roster")
