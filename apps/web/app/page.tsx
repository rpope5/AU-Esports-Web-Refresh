        ...
        <div className="main-content">
          ...
          <div className="jersey-box">
            ...
            <div className="flex justify-between items-center mt-4">
              <a href="https://critapparel.com/collections/ashland-university?_pos=1&_psq=Ashla&_ss=e&_v=1.0" className="shop-btn">
                <img src="/crit.png" alt="Crit Apparel Logo" className="w-40 h-auto object-contain" />
              </a>
              <a href="https://theinfiniteinc.com/collections/e-sports/products/ashland-university-original-e-sports-jersey" className="shop-btn-alt">
                <img src="/infinite.png" alt="Infinite Logo" className="w-40 h-auto object-contain" />
              </a>
            </div>
          </div>
        </div>
