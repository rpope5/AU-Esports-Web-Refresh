...
export default function CODRecruitListPage() {
  ...
  useEffect(() => {
    ...
    (async () => {
      const res = await fetch(`${apiUrl}/api/v1/admin/recruits/game/cod`, {
        headers: {
      ...
      if (!res.ok) {
        ...
        console.error("Failed to load COD recruits:", res.status, text);
  ...
  return (
    <div className="p-6">
      <div className="flex items-center justify-between gap-4">
        <div>
          <h1 className="text-2xl font-semibold">Call of Duty Recruits</h1>
          <p className="mt-1 text-sm text-neutral-400">
            Review Call of Duty applicants and rankings.
          </p>
        </div>
