...
export default function R6RecruitListPage() {
  ...
  useEffect(() => {
    ...
    (async () => {
      const res = await fetch(`${apiUrl}/api/v1/admin/recruits/game/r6`, {
        headers: {
      ...
      if (!res.ok) {
        ...
        console.error("Failed to load R6 recruits:", res.status, text);
  ...
  return (
    <div className="p-6">
      <div className="flex items-center justify-between gap-4">
        <div>
          <h1 className="text-2xl font-semibold">Rainbow Six Siege Recruits</h1>
          <p className="mt-1 text-sm text-neutral-400">
            Review Rainbow Six Siege applicants and rankings.
          </p>
        </div>
