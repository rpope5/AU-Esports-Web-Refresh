...
export default function R6RecruitListPage() {
  ...
  useEffect(() => {
    ...
    (async () => {
      const res = await fetch(`${apiUrl}/api/v1/admin/recruits/game/hearthstone`, {
        headers: {
      ...
      if (!res.ok) {
        ...
        console.error("Failed to load Hearthstone recruits:", res.status, text);
  ...
  return (
    <div className="p-6">
      <div className="flex items-center justify-between gap-4">
        <div>
          <h1 className="text-2xl font-semibold">Hearthstone Recruits</h1>
          <p className="mt-1 text-sm text-neutral-400">
            Review Hearthstone applicants and rankings.
          </p>
        </div>
